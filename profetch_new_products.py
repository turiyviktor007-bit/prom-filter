...
def generate_xls(new_items, output_path, on_progress):
    ...
    for idx, p in enumerate(new_items):
        ...
        p["params"]["Состояние"]                        = "Новое"
        p["params"]["Узоры и принты"]                   = "Без узоров и принтов"
        p["params"]["Форм-фактор"]                      = "Панель (Накладка на корпус)"
        p["params"]["Совместимость с беспроводной зарядкой"] = "Да"
